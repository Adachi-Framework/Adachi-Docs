...
* [新增插件配置 `publicDirs`，对指定目录列表提供静态资源托管](../../guide/plugin/public-dirs.md)
...
* [新增刷新注册方法 `refreshRegister`，用于替代原来的 `bot.refresh.register`](../../guide/plugin/lifecycle.md#renderregister)
